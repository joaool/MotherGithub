...
CKEDITOR.dialog.add("smiley", function (f) {
    for (var e = f.config, a = f.lang.smiley, h = e.smiley_images, g = e.smiley_columns || 8, i, k = function k(j) {
        ...
        switch (b) {
            ...
            case 32:
                ...
                break;
            case d ? 37 : 39:
                if (b = c.getParent().getNext()) b = b.getChild(0), b.focus(), a.preventDefault(!0);else if (b = c.getParent().getParent().getNext()) (b = b.getChild([0, 0])) && b.focus(), a.preventDefault(!0);
                break;
            case d ? 39 : 37:
...
//# sourceMappingURL=smiley-compiled.js.map

//# sourceMappingURL=smiley-compiled-compiled.js.map