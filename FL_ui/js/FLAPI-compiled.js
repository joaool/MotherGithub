...
// var fl = new flMain();
// var fa = FL.login.token.fa;//new fl.app();
var fField=new fl.field();var field_id=obj._id;fField.update({"query":{"_id":field_id},"update":{"3":obj.name_3,"4":obj.description_4,"K":obj.label_K,"M":obj.type_M,"9":obj.typeUI_9,"N":obj.enumerable_N,"O":obj.Nico_O,"P":obj.Nico_P}},function(err,data){FL.common.printToConsole("............................._fieldUpdate...."); // err = "abc";
if(err){ // alert("ERROR ON _addWithFields err="+err);
