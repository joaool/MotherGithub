...
(function (p, z) {
  function q(a) {
    ...
    var d,
        a = a || {},
        b = b || {};for (d in b) b.hasOwnProperty(d) && null == a[d] && (a[d] = b[d]);return a;
  }function j(a, b, d) {
    var c = [],
        e,
        h;if (!a) return c;if (w && a.map === w) return a.map(b, d);for (e = 0, h = a.length; e < h; e++) c[e] = b.call(d, a[e], e, a);return c;
  }function n(a, b) {
...
//# sourceMappingURL=accounting.min-compiled.js.map