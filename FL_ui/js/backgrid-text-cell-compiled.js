  ...
  var TextareaEditor = Backgrid.Extension.TextareaEditor = Backgrid.CellEditor.extend({
    ...
    */
    saveOrCancel: function saveOrCancel(e) {
      ...
      } else if (!e || e.type == 'submit' || e.type == 'hide' && newValue !== (this.model.get(this.column.get('name')) || '').replace(/\r/g, '') && confirm('Would you like to save your changes?')) {
...
//# sourceMappingURL=backgrid-text-cell-compiled.js.map