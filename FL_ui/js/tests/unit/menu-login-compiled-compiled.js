...
QUnit.extend(QUnit, { //QUnit extension to support inArray
    inArray: function inArray(actual, expectedValues, message) {
...
$(function () {
    ...
    test("basic test & FL.common & FL.dd", function () {
    ...
    //   equal(actual,expected,"...are equal");//non strict assertion
    // });
    test("FL.menu primitives", function () {
        //one test can have several assertions
        var oMenu = {
            "menu": [{
                "title": "MenuA/T1", //0
    ...
    test("FL.menu DOM editable=false", function () {
        ...
        var add = function add(a, b) {
            var result = a + b;$("input#ResultTestBox").val(result);
        };
        var result = add(2, 3);
    ...
    test("FL.common tests", function () {
        ...
        var arrOfRowValues = ["March 21, 2012", "03-21-2012",
        //var d = Date.parse("15-21-12");//NaN
        "03/21/2012", "21-Mar-2012"];
        ...
        arrOfRowValues = ["March 21, 2012", "03-21-12", "15-21-12", //ofending value
        "03/21/2012", "21-Mar-2012"];
        ...
        arrOfRowValues = ["4.294.967.295,00", "1000", "1000,3", "0,324", "-27,2 "];
        ...
        arrOfRowValues = ["-4294", "1,000,102", //us
        "1.000,3", "0.324", //is already in a valid format
        "-27"];
        ...
        arrOfRowValues = ["-4294", "1 000 102", "1 000,3", "0,324", "-27"];
        ...
        arrOfRowValues = ["-4294", "1.a00.102", "1.000,3", "0,324", "-27"];
        success = FL.common.convertStringVectorToNumber(arrOfRowValues, "de");
    ...
    test("client Dictionary tests", function () {
        //one test can have several assertions
        //client
        ...
        var list = [];
        _.each(listAll, function (element) {
            list.push(element.singular);
        });
        ...
        { shipped: true, product: "Super 1" }, { shipped: false, product: "Super 2" }, { shipped: false, product: "Super 3" }, { shipped: true, product: "Super 4" }];
    ...
    test("FL.server testing server interface functions (no connection need)", function () {
        ...
        var rowsArr = [{ shipped: true, product: "Super 1" }, { shipped: false, product: "Super 2" }, { shipped: false, product: "Super 3" }, { shipped: true, product: "Super 4" }];
...
//# sourceMappingURL=menu-login-compiled.js.map

//# sourceMappingURL=menu-login-compiled-compiled.js.map