jQuery(document).ready(function ($) {
    ...
    FL["login"] = (function () {//name space FL.login
        ...
        var loginDialogs = function (loginObject) {
            ...
            FL.common.editMasterDetail("B", " Sign in to FrameLink", "loginTemplate", masterDetailItems, {
                type: "primary",
                icon: "user",
                button1: btn1Caption,
                button2: "Sign in"
        ...
        var getStartedDialogs = function (loginObject) {
            ...
            FL.common.editMasterDetail("B", " Get started with FrameLink", "getStartedTemplate", masterDetailItems, {
                type: "primary",
                icon: "thumbs-up",
                button1: "Cancel",
                button2: "Start now"
                ...
                if (!exist) {//the user does not exist we can create-it
                    ...
                    createUserPromise = FL.API.createUserAndDefaultApp(loginObject.email, loginObject.password, "First app of " + userName)
                        .then(function () {
                            ...
                            FL.common.printToConsole("FLlogin2newUserAccess->fail");
                            return def.reject(err);
                        });
                } else {//user exist !!!
                    spinner.stop();
        ...
        return {
            ...
            home: function () {//called when user clicks the brand image
                // alert("the brand !!!");
