...
(function () { //App is a name space.
    ...
    $(document).ready(function () {
        ...
        FL.common.debugFiltersToShow = ["API", "util", "checkServerCall", "abc", "grid","apigee", "login", "dump", "dd","modalIn"];//note that "dump" is a reserved word for FL.dd.displayEntities()
        FL.API.fl.setTraceClient(2);
        //alert("xuxu_all");
