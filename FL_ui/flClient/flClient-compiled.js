...
(function () {
    ...
    var axCall = function axCall(protocol, srv, port, path, jsonData, callBack, trace) {
    ...
    var flMain = (function () {
        ...
        var flMain = function flMain(ax) {
            if (typeof callAjax == 'function') {
                ...
                if (typeof ax == 'function') {
                    ...
                    axCall = ax;
                } else throw new Error('flMain: bad argument-callAjax is not defined');
            }
        };
        // utility API
        ...
        function resetTraceValue(traceVal) {
            if (traceVal < 0) return -1;
            if (traceVal > 65535) return 65535;
            return traceVal;
        }
        ...
        flMain.prototype.userCreate = function (jsonData, callBack) {
            ...
            if (isFlagged(4)) generateFunction('fl', 'userCreate', undefined, JSON.stringify(jsonData));
        ...
        flMain.prototype.userChangePassWord = function (jsonData, callBack) {
            ...
            if (isFlagged(4)) generateFunction('fl', 'userChagePassWord', undefined, JSON.stringify(jsonData));
        ...
        flMain.prototype.userChangeName = function (jsonData, callBack) {
            ...
            if (isFlagged(4)) generateFunction('fl', 'userChangeName', undefined, JSON.stringify(jsonData));
        ...
        flMain.prototype.userChangeType = function (jsonData, callBack) {
            ...
            if (isFlagged(4)) generateFunction('fl', 'userChangeType', undefined, JSON.stringify(jsonData));
        ...
        flMain.prototype.promoteAsClientAdmin = function (jsonData, callBack) {
            ...
            if (isFlagged(4)) generateFunction('fl', 'promoteAsClientAdmin', undefined, JSON.stringify(jsonData));
        ...
        flMain.prototype.userRemove = function (jsonData, callBack) {
            ...
            if (isFlagged(4)) generateFunction('fl', 'userRemove', undefined, JSON.stringify(jsonData));
        ...
        flMain.prototype.isUserExist = function (jsonData, callBack) {
            ...
            if (isFlagged(4)) generateFunction('fl', 'isUserExist', undefined, JSON.stringify(jsonData));
        ...
        flMain.prototype.userGetList = function (jsonData, callBack) {
            ...
            if (isFlagged(4)) generateFunction('fl', 'userGetList', undefined, JSON.stringify(jsonData));
        ...
        flMain.prototype.clientCreate = function (jsonData, callBack) {
            ...
            if (isFlagged(4)) generateFunction('fl', 'clientCreate', undefined, JSON.stringify(jsonData));
        ...
        flMain.prototype.clientChangeName = function (jsonData, callBack) {
            ...
            if (isFlagged(4)) generateFunction('fl', 'clientChangeName', undefined, JSON.stringify(jsonData));
        ...
        flMain.prototype.clientRemove = function (jsonData, callBack) {
            ...
            if (isFlagged(4)) generateFunction('fl', 'clientRemove', undefined, JSON.stringify(jsonData));
        ...
        flMain.prototype.clientGetList = function (jsonData, callBack) {
            ...
            if (isFlagged(4)) generateFunction('fl', 'clientGetList', undefined, JSON.stringify(jsonData));
        ...
        flMain.prototype.applicationFullCreate = function (jsonData, callBack) {
            ...
            if (isFlagged(4)) generateFunction('fa', 'applicationFullCreate', undefined, JSON.stringify(jsonData));
        ...
        flMain.prototype.applicationFinalize = function (jsonData, callBack) {
            if (!checkParam(jsonData.adminName, jsonData.adminPassWord, jsonData.userName, jsonData.clientName, jsonData.domainName, jsonData.newUserName, jsonData.newClientName, jsonData.newDescription, callBack)) {
                callBack('Bad parameter', null);
            }
            if (isFlagged(4)) generateFunction('fa', 'applicationfinalizeApp', undefined, JSON.stringify(jsonData));
            sendCommand(1, 'fl/applicationfinalizeApp', '-1', jsonData, {}, callBack);
        };
        flMain.prototype.applicationCreate = function (jsonData, callBack) {
            if (!checkParam(jsonData.adminName, jsonData.adminPassWord, jsonData.domainPrefix, jsonData.description, callBack)) {
                callBack('Bad parameter', null);
                return;
            }
            if (isFlagged(4)) generateFunction('fa', 'applicationCreate', undefined, JSON.stringify(jsonData));
        ...
        flMain.prototype.applicationRemove = function (jsonData, callBack) {
            ...
            if (isFlagged(4)) generateFunction('fa', 'applicationRemove', undefined, JSON.stringify(jsonData));
        ...
        flMain.prototype.applicationGetNextDomainName = function (jsonData, callBack) {
            ...
            if (isFlagged(4)) generateFunction('fl', 'applicationGetNextDomainName', undefined, JSON.stringify(jsonData));
        ...
        flMain.prototype.applicationGrantAccess = function (jsonData, callBack) {
            ...
            if (!checkParam(jsonData.domainName, jsonData.adminName, jsonData.adminPassWord, jsonData.userName, jsonData.accessLevel, callBack)) {
                callBack('Bad parameter', null);
                return;
            }
            if (isFlagged(4)) generateFunction('fa', 'applicationGrantAccess', undefined, JSON.stringify(jsonData));
        ...
        flMain.prototype.applicationChangeDomainName = function (jsonData, callBack) {
            //console.dir(jsonData);
            if (!checkParam(jsonData.domainName, jsonData.adminName, jsonData.adminPassWord, jsonData.newDomainName, callBack)) {
                callBack('Bad parameter', null);
                return;
            }
            if (isFlagged(4)) generateFunction('fa', 'applicationChangeDomainName', undefined, JSON.stringify(jsonData));
        ...
        flMain.prototype.applicationChangeDescription = function (jsonData, callBack) {
            //console.dir(jsonData);
            if (!checkParam(jsonData.domainName, jsonData.adminName, jsonData.adminPassWord, jsonData.newDescription, callBack)) {
                callBack('Bad parameter', null);
                return;
            }
            if (isFlagged(4)) generateFunction('fa', 'applicationChangeDescription', undefined, JSON.stringify(jsonData));
        ...
        flMain.prototype.app = (function () {
            ...
            app.prototype.connect = function (j, callBack) {
                ...
                var self = this;
                if (checkParam(j.apiPort, j.apiServer, j.storeServer, j.storePort, j.dbName, j.secret, j.apiProtocol, callBack) == false) return callBack('bad parameters', null);
            ...
            app.prototype.init = function (initData, callBack) {
                if (checkParam(callBack) == false) return callBack('bad parameters', null);

                if (checkParam(initData, initData.application, initData.adminId, callBack) == false) return callBack('bad parameters', null);
                sendApiSrv('flApp/zinit', initData, callBack);
            };
            app.prototype.grantAccess = function (grantData, callBack) {
                if (checkParam(grantData.userId, grantData.accessLevel, callBack) == false) return callBack('bad parameters', null);
            ...
            app.prototype.remove = function (removeData, callBack) {
                ...
                if (checkParam(removeData, removeData.domain, removeData.hash, removeData.date, callBack) == false) return callBack('bad parameters', null);
                sendApiSrv('flApp/zremove', removeData, callBack);
            };
            app.prototype.setMenuLevel = function (menuLevelData, callBack) {
                if (checkParam(callBack) == false) return callBack('bad parameters', null);

                if (checkParam(menuLevelData, menuLevelData['0D'], menuLevelData['0E'], callBack) == false) return callBack('bad parameters', null);
            ...
            app.prototype.setLoginRestriction = function (loginRestricData, callBack) {
                ...
                if (checkParam(loginRestricData, loginRestricData['1'], loginRestricData['0D'], loginRestricData['0E'], callBack) == false) return callBack('bad parameters', null);
                sendApiSrv('application/setloginrestriction', loginRestricData, callBack);
            };
            app.prototype.disconnect = function (callBack) {
                if (strTraceTxt.length > 0) console.log(strTraceTxt);
                strTraceTxt = '';
            ...
            */
            data.prototype.insert = function (eCN, d, callBack) {
                if (d.length == undefined && checkParamOnly(d.d, 'StopHere') == false || d.length == 0) {
                    if (isFlagged(4)) console.log('// fd.insert("' + eCN + '", ' + JSON.stringify(d) + ');        // *** INVALID PARAMETERS ***');
                    throw new Error('Invalid parameters');
                }
                if (isFlagged(4)) generateFunction('fd', 'insert', eCN, JSON.stringify(d));
                sendCommand(2, 'data/insert', eCN, d, {}, callBack);
            };
            data.prototype.findOne = function (eCN, options, callBack) {
                if (checkParamOnly(options.query, 'StopHere') == false) throw new Error('Invalid parameters');
                if (isFlagged(4)) generateFunction('fd', 'findOne', eCN, JSON.stringify(options));
                sendCommand(2, 'data/findOne', eCN, options, callBack);
            };
            data.prototype.findAll = function (eCN, options, callBack) {
                if (checkParamOnly(options.query, 'StopHere') == false) throw new Error('Invalid parameters');
                if (isFlagged(4)) generateFunction('fd', 'findAll', eCN, JSON.stringify(options));
                sendCommand(2, 'data/findAll', eCN, options, callBack);
            };
            data.prototype.update = function (eCN, options, callBack) {
                if (checkParamOnly(options.update, options.query, 'StopHere') == false) throw new Error('Invalid parameters');
                if (isFlagged(4)) generateFunction('fd', 'update', eCN, JSON.stringify(options));
                sendCommand(2, 'data/update', eCN, options, callBack);
            };
            data.prototype.findAndModify = function (eCN, options, callBack) {
                if (checkParamOnly(options, 'StopHere') == false) throw new Error('Invalid parameters');
                if (isFlagged(4)) generateFunction('fd', 'findAndModify', eCN, JSON.stringify(options));
                sendCommand(2, 'data/findandmodify', eCN, options, callBack);
            };
            data.prototype.remove = function (eCN, options, callBack) {
                if (checkParamOnly(options.query, 'StopHere') == false) throw new Error('Invalid parameters');
                if (isFlagged(4)) generateFunction('fd', 'remove', eCN, JSON.stringify(options));
            ...
            data.prototype.count = function (eCN, options, callBack) {
                ...
                if (isFlagged(4)) generateFunction('fd', 'count', eCN, JSON.stringify(options));
        ...
        flMain.prototype.entity = (function () {
            ...
            entity.prototype.add = function (data, callBack) {
                if (miniFieldIncluded(0, data) == false) return callBack('Invalid arguments', null);
                data['2'] = 'E';
                if (isFlagged(4)) generateFunction('fEnt', 'add', null, JSON.stringify(data));
                sendCommand(2, 'data/insert', '0', { d: data }, {}, callBack);
            };
            entity.prototype.addWithFields = function (data, callBack) {
                if (!checkEntityWithFields(data)) return callBack('Invalid arguments', null);
                if (isFlagged(4)) generateFunction('fEnt', 'addWithField', null, JSON.stringify(data));
            ...
            entity.prototype.getOne = function (options, callBack) {
                if (checkParamOnly(options, options['query'], 'StopHere') == false) return callBack('Invalid arguments', null);
                jsonConcat(options.query, { '2': 'E' }, '');
                if (isFlagged(4)) generateFunction('fEnt', 'getOne', null, JSON.stringify(options));
                adjustSystemDico(options);
                if (options.projection == undefined) options.projection = getDefaultProjection(0);
                sendCommand(2, 'data/findOne', '0', {}, options, callBack);
            };
            entity.prototype.getAll = function (options, callBack) {
                if (checkParamOnly(options, options['query'], 'StopHere') == false) return callBack('Invalid arguments', null);
                jsonConcat(options.query, { '2': 'E' }, '');
                if (isFlagged(4)) generateFunction('fEnt', 'getAll', null, JSON.stringify(options));
                adjustSystemDico(options);
                if (options.projection == undefined) options.projection = getDefaultProjection(0);
            ...
            entity.prototype.count = function (options, callBack) {
                if (checkParamOnly(options, options['query'], 'StopHere') == false) return callBack('Invalid arguments', null);
                jsonConcat(options.query, { '2': 'E' }, '');
                if (isFlagged(4)) generateFunction('fEnt', 'count', null, JSON.stringify(options));
                adjustSystemDico(options);
                sendCommand(2, 'data/count', '0', {}, options, callBack);
            };
            entity.prototype.findandmodify = function (options, callBack) {
                if (checkParamOnly(options, options['query'], 'StopHere') == false) return callBack('Invalid arguments', null);
                if (!updatableFieldOnly(0, options.update)) return callBack('Invalid arguments', null);
                jsonConcat(options.query, { '2': 'E' }, '');
                if (isFlagged(4)) generateFunction('fEnt', 'findandmodify', null, JSON.stringify(options));
                adjustSystemDico(options);
            ...
            entity.prototype.update = function (options, callBack) {
                ...
                if (!updatableFieldOnly(0, options.update)) return callBack('Invalid arguments', null);
                jsonConcat(options.query, { '2': 'E' }, '');
                if (isFlagged(4)) generateFunction('fEnt', 'update', null, JSON.stringify(options));
                adjustSystemDico(options);
                sendCommand(2, 'data/update', '0', {}, options, callBack);
            };
            entity.prototype.getAllWithField = function (options, callBack) {
                if (checkParamOnly(options, options['query'], 'StopHere') == false) throw new Error('Invalid arguments');
                jsonConcat(options.query, { '2': 'E' }, '');
                if (isFlagged(4)) generateFunction('fEnt', 'getAllWithField', null, JSON.stringify(options));
                adjustSystemDico(options);
                if (options.projection == undefined) options.projection = getDefaultProjection(0);
        ...
        flMain.prototype.field = (function () {
            ...
            field.prototype.add = function (data, callBack) {
                if (!miniFieldIncluded(1, data)) return callBack('Invalid arguments', null);
                data['2'] = 'F';
                if (isFlagged(4)) generateFunction('fField', 'add', null, JSON.stringify(data));
                sendCommand(2, 'data/insert', '0', { d: data }, {}, callBack);
            };
            // iNet should be like: {"query":{"_id":eCN}, projection:{}}
            field.prototype.getOne = function (options, callBack) {
                ...
                if (isFlagged(4)) generateFunction('fField', 'getOne', null, JSON.stringify(options));
                adjustSystemDico(options);
                if (options.projection == undefined) options.projection = getDefaultProjection(1);
                sendCommand(2, 'data/findOne', '0', {}, options, callBack);
            };
            field.prototype.getAll = function (options, callBack) {
                if (checkParamOnly(options, options['query'], 'StopHere') == false) return callBack('Invalid arguments', null);
                jsonConcat(options.query, { '2': 'F' }, '');
                if (isFlagged(4)) generateFunction('fField', 'getAll', null, JSON.stringify(options));
                adjustSystemDico(options);
                if (options.projection == undefined) options.projection = getDefaultProjection(1);
                sendCommand(2, 'data/findAll', '0', {}, options, callBack);
            };
            field.prototype.update = function (options, callBack) {
                if (checkParamOnly(options, options['query'], 'StopHere') == false) return callBack('Invalid arguments', null);
                if (!updatableFieldOnly(1, options.update)) return callBack('Invalid arguments', null);
                jsonConcat(options.query, { '2': 'F' }, '');
                if (isFlagged(4)) generateFunction('fField', 'update', null, JSON.stringify(options));
                adjustSystemDico(options);
                sendCommand(2, 'data/update', '0', {}, options, callBack);
            };
            field.prototype.count = function (options, callBack) {
                if (checkParamOnly(options, options['query'], 'StopHere') == false) return callBack('Invalid arguments', null);
                jsonConcat(options.query, { '2': 'F' }, '');
                if (isFlagged(4)) generateFunction('fField', 'count', null, JSON.stringify(options));
                adjustSystemDico(options);
                sendCommand(2, 'data/count', '0', {}, options, callBack);
            };
            field.prototype.findandmodify = function (options, callBack) {
                ...
                if (!updatableFieldOnly(1, options.update)) return callBack('Invalid arguments', null);
                jsonConcat(options.query, { '2': 'F' }, '');
                if (isFlagged(4)) generateFunction('fField', 'findandmodify', null, JSON.stringify(options));
                adjustSystemDico(options);
                sendCommand(2, 'data/findandmodify', '0', {}, options, callBack);
            };
            field.prototype.update = function (options, callBack) {
        ...
        flMain.prototype.relation = (function () {
            ...
            relation.prototype.add = function (data, callBack) {
                //console.dir(data);
                if (!miniFieldIncluded(2, data)) return callBack('Invalid arguments', null);
                data['1'] = '-1';
                data['2'] = 'R';
                if (isFlagged(4)) generateFunction('fRel', 'add', null, JSON.stringify(data));
                sendCommand(2, 'data/insert', '0', { d: data }, {}, callBack);
            };
            // iNet should be like: {"query":{"_id":eCN}, projection:{}}
            relation.prototype.getOne = function (options, callBack) {
                ...
                if (isFlagged(4)) generateFunction('fRel', 'getOne', null, JSON.stringify(options));
                adjustSystemDico(options);
                if (options.projection == undefined) options.projection = getDefaultProjection(2);
                sendCommand(2, 'data/findOne', '0', {}, options, callBack);
            };
            relation.prototype.getAll = function (options, callBack) {
                if (checkParamOnly(options, options['query'], 'StopHere') == false) return callBack('Invalid arguments', null);
                jsonConcat(options.query, { '2': 'R' }, '');
                if (isFlagged(4)) generateFunction('fRel', 'getAll', null, JSON.stringify(options));
                adjustSystemDico(options);
                if (options.projection == undefined) options.projection = getDefaultProjection(2);
                sendCommand(2, 'data/findAll', '0', {}, options, callBack);
            };
            ...
            */
            relation.prototype.count = function (options, callBack) {
                if (checkParamOnly(options, options['query'], 'StopHere') == false) throw new Error('Invalid arguments');
                jsonConcat(options.query, { '2': 'R' }, '');
                if (isFlagged(4)) generateFunction('fRel', 'count', null, JSON.stringify(options));
                adjustSystemDico(options);
                sendCommand(2, 'data/count', '0', {}, options, callBack);
            };
            /*
        ...
        flMain.prototype.mailChimp = (function () {
            var mailChimp = function mailChimp() {};
            // API going to the server
        ...
        flMain.prototype.mandrill = (function () {
            var mandrill = function mandrill() {};
            // API going to the server
    ...
    function adjustSystemDico(options) {
        ...
        if (options.noPrefix == true) throw new Error('impossible to use noPrefix:true in this call');
    ...
    function areKeysAllowed(forbidenKeys, js) {
        ...
        for (var fk in forbidenKeys) forbidWithPrefix.push('d.' + forbidenKeys[fk]);
        //console.dir(forbidWithPrefix);
        for (ii in js) {
            if (typeof js[ii] == 'object') if (this.areKeysAllowed(forbidenKeys, js[ii]) == false) return false;
            if (forbidenKeys.indexOf(ii) >= 0 || forbidWithPrefix.indexOf(ii) >= 0) return false;
        }
        return true;
    }
    ...
    function sendMainSrv(apiName, superJ, callBack) {
        ...
        if (isFlagged(2)) FL.common.printToConsole('   => ' + apiName + ' : ' + JSON.stringify(superJ), 'API');

        function api2CallBack(err, data) {
            //console.log ('<= ' + apiName + '-callBack data= ' + JSON.stringify(data) + ', err: ' + err);
            if (err) {
                if (isFlagged(2)) FL.common.printToConsole('   <= ' + apiName + '-callBack : ** ERROR ** : ' + err, 'API');
                return callBack(err, null);
            }
            if (isFlagged(2)) FL.common.printToConsole('   <= ' + apiName + ' data: ' + JSON.stringify(data), 'API');
            return callBack(null, data);
        }
    ...
    function isFlagged(flg) {
        if ((flg & flTraceClient) == flg) return true;
        return false;
    }
    ...
    function checkParamOnly() {
        ...
        for (var indArg in arguments) {
            ...
            ii++;
            if (arguments[indArg] == 'StopHere') return true;
        }
    ...
    function miniFieldIncluded(ind, js) {
        ...
        JSON.stringify(js, function (k, v) {
            if (rslt[k] == undefined) rslt[k] = 1;else rslt[k]++;
            return v;
        });
        //console.dir(rslt);
    ...
    function updatableFieldOnly(ind, js2) {
        ...
        JSON.stringify(js, function (k, v) {
            ...
            if (k == '' | k[0] == '$' || typeof v == 'object' && !(v instanceof Array)) return v;
            if (rslt[k] == undefined) rslt[k] = 1.0;else rslt[k] = rslt[k] + 1;
    ...
    if (typeof module !== 'undefined' && typeof module.exports !== 'undefined') module.exports = flMain;else window.flMain = flMain;
})();

//# sourceMappingURL=flClient-compiled.js.map